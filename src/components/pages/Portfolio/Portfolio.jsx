        ...
        {proyects.map((p, index) => (
          <div key={index} className=" bg-color_purple2 p-5 rounded-3xl ">
            <div className=" mx-auto flex flex-col gap-y-7 ">
              {/* <div className="flex justify-center  max-w-2xl object-cover"> */}
...
const proyects = [
...

  {
    ...
    detalle: (
      <p>
        {" "}
        Esta landing page fue construida para
        <a
          href="https://idexaperu.com/"
          target="_blank"
        ...
        una reciente empresa en el mercado para solucionar distintos problemas
        informáticos en la localidad de Huancayo principalmente.
      </p>
    ),
  ...
  },
  {
    ...
    description:
      "Aplicación web para generar listas con voz e inteligencia artificial.",
    detalle:
